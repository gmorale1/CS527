...
class PSO:
    def __init__(self, num_particles, inertia, phi_1, phi_2, ww, wh, max_vel, func):
...
parser.add_argument("--func", default="Rosenbrock", type=str, help="Optimization function")
...
# Create PSO
pso = PSO(args.num_particles, args.inertia, args.cognition, args.social, 100, 100, 2, args.func)
